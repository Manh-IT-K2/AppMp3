package com.example.app.ui.audio
...
import com.example.app.Media.ExoPlayer.MediaPlayerServiceConnection
import com.example.app.Media.ExoPlayer.currentPosition
import com.example.app.Media.ExoPlayer.isPlaying
import com.example.app.Media.Service.MediaPlayerService
...
class AudioViewModel @Inject constructor(
    ...
    var audioList = mutableStateListOf<AudioModel>()
    ...
    private suspend fun getAndFormatAudioData(): List<AudioModel> {
        return repository.getAudioData().map {
            val displayName = it.disPlayName.substringBefore(".")
            val artist = if (it.artists.contains("<unknown>"))
                "Unknown Artist" else it.artists
            it.copy(
    ...
    fun playAudio(currentAudio: AudioModel) {
